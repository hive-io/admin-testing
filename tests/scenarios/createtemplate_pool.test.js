...
describe('Create New Template and Pool', () => {
  ...
  it('should create a new template', () => {
    return browser.waitForVisible('//tbody')
      .then(() => browser.isExisting('//td[1 and text()="forest"]'))
      ...
      .then(() => browser.setValue('//*[@id="editTemplate"]//*[@id="path"]','192.168.11.4:/NFS/Guests/testing'))
      .then(() => browser.selectByVisibleText('//*[@id="editTemplate"]//*[@id="os"]', 'Linux'))
      .then(() => browser.setValue('//*[@id="editTemplate"]//*[@id="dsize"]','10'))
      .then(() => browser.click('//*[@id="editTemplate"]//*[@id="cdromChk"]'))
      .then(() => browser.waitForVisible('//*[@id="editTemplate"]//*[@id="cdrom"]'))
      .then(() => browser.setValue('//*[@id="editTemplate"]//*[@id="cdrom"]','192.168.11.4:/NFS/Iso/server-16.04.iso'))
      ...
      .then(() => browser.waitForVisible('//td[1 and text()="forest"]'))
  ...
  it('should check if new template console works', () => {
    ...
    return browser.getTabIds()
      .then((ids) => oldIds = ids)
      .then(() => common.waitAndClick('//td[1 and text()="forest"]/..//td//button[text()="Console"]'))
      ...
      .then(() => browser.close())
      .then(() => browser.waitForVisible('//td[1 and text()="forest"]/..//td//button[text()="Console"]'))
  });

  it('should power off and undefine the image', () => {
    return browser.waitForExist('//tbody')
      .then(() => common.waitAndClick('//td[1 and text()="forest"]/..//td//button[text()="Power Off"]'))
      .then(() => browser.waitForExist('//tbody'))
      .then(() => common.waitAndClick('//td[1 and text()="forest"]/..//td//button[text()="Undefine"]'))
      .then(() => browser.waitForExist('//tbody'))
      .then(() => browser.waitForExist('//td[1 and text()="forest"]/..//td//button[text()="Author"]'))
  });
  ...
  it('should delete the created image on the NFS server', () => {
    return browser.pause(2000)
      .then(() => common.checkAndDeleteFile('/nfs/Guests/testing'))
      .catch(e => console.log('File Not Found.'));
  });
