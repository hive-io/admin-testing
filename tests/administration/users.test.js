...
describe('Users', () => {
  ...
  it('should allow password changes for admin', () => {
  	return browser.click('//td[contains(text(),"admin") and position()=1]/..//button[contains(@id,"cp")]')
  	  .then(() => browser.waitForExist('//td[contains(text(),"admin") and position()=1]/..//form//input[@id="password"]'))
  ...
  it('should allow deletion of readonly user', () => {
  	return browser.waitForExist('//td[text()="readonly" and position()=1]/..//button[contains(@id,"rm")]')
      .then(() => browser.click('//td[text()="readonly" and position()=1]/..//button[contains(@id,"rm")]'))
  	  .then(() => browser.waitForExist('//td[text()="readonly" and position()=1]/..//button[contains(@id,"rm")]', 500, true))
  });
